...
import 'package:instaclone/Recommendations/faceshaperec.dart';
...
class Faceshaperesults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Faceshaperesults(
      {super.key, required this.results, required this.image});

  @override
  FaceshaperesultsState createState() => FaceshaperesultsState();
}

class FaceshaperesultsState extends State<Faceshaperesults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Faceshaperec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
