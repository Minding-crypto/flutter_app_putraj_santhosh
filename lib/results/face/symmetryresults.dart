...
class Symmetryresults extends StatefulWidget {
  ...
  @override
  SymmetryresultsState createState() => SymmetryresultsState();
}

class SymmetryresultsState extends State<Symmetryresults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => RecommendationsPage(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
                            ...
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all<Color>(Color.fromARGB(255, 107, 33, 243)), // Set the background color here
