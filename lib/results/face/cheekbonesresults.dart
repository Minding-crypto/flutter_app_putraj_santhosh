...
import 'package:instaclone/Recommendations/cheekbonesrec.dart';
...
class Cheekbonesresults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Cheekbonesresults(
      {super.key, required this.results, required this.image});

  @override
  CheekbonesresultsState createState() => CheekbonesresultsState();
}

class CheekbonesresultsState extends State<Cheekbonesresults> {
                              ...
                              children: [
                                ...
                                Container(
                                  child: Center(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: 'Left Cheekbone Prominence:  ',
                                        style: GoogleFonts.roboto(
                                          fontSize: 18,
                                          color: Colors.black,
                                        ),
                                ...
                                Container(
                                  child: Center(
                                    ...
                                    children: [
                                      TextSpan(
                                        text: 'Right Cheekbone Prominence:  ',
                                        style: GoogleFonts.roboto(
                                          fontSize: 18,
                                          color: Colors.black,
                                        ),
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Cheekbonesrec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
