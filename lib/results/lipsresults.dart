...
import 'package:instaclone/Recommendations/lipsrec.dart';
...
class Lipsresults extends StatefulWidget {
  ...
  @override
  LipsresultsState createState() => LipsresultsState();
}

class LipsresultsState extends State<Lipsresults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Lipsrec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
