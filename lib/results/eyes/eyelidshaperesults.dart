...
import 'package:instaclone/Recommendations/eyelidshaperec.dart';
...
class Eyelidshaperesults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Eyelidshaperesults(
      {super.key, required this.results, required this.image});

  @override
  EyelidshaperesultsState createState() => EyelidshaperesultsState();
}

class EyelidshaperesultsState extends State<Eyelidshaperesults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Eyelidshaperec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
