...
import 'package:instaclone/Recommendations/eyeshaperec.dart';
...
class Eyeshaperesults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Eyeshaperesults({super.key, required this.results, required this.image});

  @override
  EyeshaperesultsState createState() => EyeshaperesultsState();
}

class EyeshaperesultsState extends State<Eyeshaperesults> {
                      ...
                      children: <Widget>[
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      Eyeshaperec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              // Convert image to File if it's XFile
                              final File imageFile = widget.image is XFile
