...
import 'package:instaclone/Recommendations/canthaltiltrec.dart';
...
class Canthaltiltresults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Canthaltiltresults(
      {super.key, required this.results, required this.image});

  @override
  CanthaltiltresultsState createState() => CanthaltiltresultsState();
}

class CanthaltiltresultsState extends State<Canthaltiltresults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Canthaltiltrec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
