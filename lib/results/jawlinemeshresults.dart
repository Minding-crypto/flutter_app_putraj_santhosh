...
import 'package:instaclone/Recommendations/jawlinerec.dart';
...
class Jawlinemeshresults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Jawlinemeshresults(
      {super.key, required this.results, required this.image});

  @override
  JawlinemeshresultsState createState() => JawlinemeshresultsState();
}

class JawlinemeshresultsState extends State<Jawlinemeshresults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Jawlinerec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
