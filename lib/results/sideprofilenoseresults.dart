...
import 'package:instaclone/Recommendations/sidenoseshaperec.dart';
...
class Sideprofilenoseresults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Sideprofilenoseresults(
      {super.key, required this.results, required this.image});

  @override
  SideprofilenoseresultsState createState() => SideprofilenoseresultsState();
}

class SideprofilenoseresultsState extends State<Sideprofilenoseresults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Sidenoseshaperec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
