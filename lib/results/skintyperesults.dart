...
import 'package:instaclone/Recommendations/skintyperec.dart';
...
class Skintyperesults extends StatefulWidget {
  ...
  @override
  SkintyperesultsState createState() => SkintyperesultsState();
}

class SkintyperesultsState extends State<Skintyperesults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Skintyperec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
