...
import 'package:instaclone/Recommendations/eyebrowshaperec.dart';
...
class Eyebrowresults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Eyebrowresults(
      {super.key, required this.results, required this.image});

  @override
  EyebrowresultsState createState() => EyebrowresultsState();
}

class EyebrowresultsState extends State<Eyebrowresults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Eyebrowshaperec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
