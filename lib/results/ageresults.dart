...
import 'package:instaclone/Recommendations/agerec.dart';
...
class Ageresults extends StatefulWidget {
  ...
  @override
  AgeresultsState createState() => AgeresultsState();
}

class AgeresultsState extends State<Ageresults> {
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Agerec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
