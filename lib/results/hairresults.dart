...
import 'package:instaclone/Recommendations/hairrec.dart';
...
class Hairresults extends StatefulWidget {
  final String results;
  final dynamic image; // Accept both XFile and File

  const Hairresults({super.key, required this.results, required this.image});

  @override
  HairresultsState createState() => HairresultsState();
}

class HairresultsState extends State<Hairresults> {
                            ...
                            child: Column(
                              children: [
                               ...
                               const SizedBox(height: 10),
                                // Horizontal scale for hair loss grading
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Column(
                                    children: [
                                      Text(
                                        'Hair Loss Severity Scale',
                                        style: GoogleFonts.roboto(
                                          fontSize: 18,
                                          fontWeight: FontWeight.bold,
                                          color: Colors.white,
                                          ...
                                          return Column(
                                            children: [
                                              Container(
                                                width: 40,
                                                height: 20,
                                                color: index + 1 == int.parse(resultsList[0].split(': ')[0]) ? Colors.red : Colors.grey,
                                              ),
                                      ...
                                      const Row(
                                        ...
                                        children: [
                                          ...
                                          Text('Mild', style: TextStyle(color: Colors.white)),
                                          Text('Severe', style: TextStyle(color: Colors.white)),
                                        ],
                                      ),
                                    ],
                                  ),
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      Hairrec(results: widget.results),
                                ),
                              );
                            },
                            child: Center(
