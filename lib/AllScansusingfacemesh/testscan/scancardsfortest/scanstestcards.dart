...
import 'package:instaclone/AllScansusingfacemesh/testscan/testscan.dart';
...
class Scanstestcards extends StatefulWidget {
  const Scanstestcards({super.key});
 
  @override
  ScanstestcardsState createState() => ScanstestcardsState();
}

class ScanstestcardsState extends State<Scanstestcards> {
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 8.0),
                    child: Text(
                    "Detect if a Face is Present or Not",
                      style: GoogleFonts.josefinSans(
                        textStyle: const TextStyle(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                          color: Color.fromARGB(255, 119, 65, 255),
                          letterSpacing: 0.0,
                        ),
                      ),
                    ),
...
// Use the cropped image without resizing
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Testscan(imageFile: File(croppedImage.path)), // Assuming FaceMeshScreen takes an imageFile argument
          ),
        );
      }
    }
                                ...
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                        color: Colors.black,
                                        fontSize:
                                            17 // Adjust the text color as needed
                                        ),
                                  ),
                                ],
                              ),
