...
import 'package:instaclone/AllScansusingfacemesh/lips/lipsmesh/lipmesh.dart';
...
class Scanslipshapecards extends StatefulWidget {
  const Scanslipshapecards({super.key});

  @override
  ScanslipshapecardsState createState() => ScanslipshapecardsState();
}

class ScanslipshapecardsState extends State<Scanslipshapecards> {
  ...
  final List<Map<String, dynamic>> _secondPageInstructions = [
  ...
  
    {
     ...
     {
      'image': 'assets/Screenshot 2024-06-09 154449.png',
      'text': const Row(
  children: [
    Text( '❌ ',
              style: TextStyle(color: Colors.red, fontSize: 18),),
...
// Use the cropped image without resizing
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) =>Lipmesh(imageFile: File(croppedImage.path)), // Assuming FaceMeshScreen takes an imageFile argument
          ),
        );
      }
    }
