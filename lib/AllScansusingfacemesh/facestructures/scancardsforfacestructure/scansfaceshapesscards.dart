...
import 'package:instaclone/AllScansusingfacemesh/facestructures/facemesh/faceshapemesh.dart';
...
class Scansfaceshapesscards extends StatefulWidget {
  const Scansfaceshapesscards({super.key});

  @override
  ScansfaceshapesscardsState createState() => ScansfaceshapesscardsState();
}

class ScansfaceshapesscardsState extends State<Scansfaceshapesscards> {
...
// Use the cropped image without resizing
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Faceshapemesh(imageFile: File(croppedImage.path)), // Assuming FaceMeshScreen takes an imageFile argument
          ),
        );
      }
    }
