...
import 'package:instaclone/AllScansusingfacemesh/facestructures/facemesh/symmetrymesh.dart';
...
class Scansfacesymmetrycards extends StatefulWidget {
  const Scansfacesymmetrycards({super.key});

  @override
  ScansfacesymmetrycardsState createState() => ScansfacesymmetrycardsState();
}

class ScansfacesymmetrycardsState extends State<Scansfacesymmetrycards> {
...
// Use the cropped image without resizing
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Symmetrymesh(imageFile: File(croppedImage.path)), // Assuming FaceMeshScreen takes an imageFile argument
          ),
        );
      }
    }
