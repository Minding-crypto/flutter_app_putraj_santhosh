...
import 'package:instaclone/AllScansusingfacemesh/facestructures/facemesh/cheekbonesmesh.dart';
...
class Scanscheekbonescards extends StatefulWidget {
  const Scanscheekbonescards({super.key});

  @override
  ScanscheekbonescardsState createState() => ScanscheekbonescardsState();
}

class ScanscheekbonescardsState extends State<Scanscheekbonescards> {
...
// Use the cropped image without resizing
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Cheekbonesmesh(imageFile: File(croppedImage.path)), // Assuming FaceMeshScreen takes an imageFile argument
          ),
        );
      }
    }
