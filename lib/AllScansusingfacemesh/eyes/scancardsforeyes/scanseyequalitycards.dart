...
import 'package:instaclone/results/eyequalityresults.dart';
...
class ScanseyequalityCards extends StatefulWidget {
  const ScanseyequalityCards({super.key});

  @override
  ScanseyequalityCardsState createState() => ScanseyequalityCardsState();
}

class ScanseyequalityCardsState extends State<ScanseyequalityCards> {
    ...
    try {
      ...
      if (_recognitions != null && _recognitions.isNotEmpty) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
               builder: (context) => Eyequalityresults(results: v, image: _image!),
          ),
        );
      } else {
