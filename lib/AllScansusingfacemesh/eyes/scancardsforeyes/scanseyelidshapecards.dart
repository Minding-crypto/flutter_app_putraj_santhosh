...
import 'package:instaclone/AllScansusingfacemesh/eyes/eyemesh/eyelidshapemesh.dart';
...
class ScanseyelidshapeCards extends StatefulWidget {
  const ScanseyelidshapeCards({super.key});

  @override
  ScanseyelidshapeCardsState createState() => ScanseyelidshapeCardsState();
}

class ScanseyelidshapeCardsState extends State<ScanseyelidshapeCards> {
  ...
  final List<Map<String, dynamic>> _secondPageInstructions = [
    ...
    {
      'image': 'assets/671c1f01911dc4ccfe4e3b3c4c7d1c77.jpg',
      'text': const Row(
  children: [
    Text( '❌ ',
...
// Use the cropped image without resizing
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Eyelidshapemesh(imageFile: File(croppedImage.path)), // Assuming FaceMeshScreen takes an imageFile argument
          ),
        );
      }
    }
