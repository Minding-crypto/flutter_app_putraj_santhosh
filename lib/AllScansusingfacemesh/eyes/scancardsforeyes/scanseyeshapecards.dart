...
import 'package:instaclone/AllScansusingfacemesh/eyes/eyemesh/eyeshapemesh.dart';
...
class ScanseyeshapeCards extends StatefulWidget {
  const ScanseyeshapeCards({super.key});

  @override
  ScanseyeshapeCardsState createState() => ScanseyeshapeCardsState();
}

class ScanseyeshapeCardsState extends State<ScanseyeshapeCards> {
...
// Use the cropped image without resizing
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Eyeshapemesh(imageFile: File(croppedImage.path)), // Assuming FaceMeshScreen takes an imageFile argument
          ),
        );
      }
    }
