...
import 'package:instaclone/AllScansusingfacemesh/eyes/eyemesh/canthaltiltmesh.dart';
...
class ScanscanthaltiltCards extends StatefulWidget {
  const ScanscanthaltiltCards({super.key});

  @override
  ScanscanthaltiltCardsState createState() => ScanscanthaltiltCardsState();
}

class ScanscanthaltiltCardsState extends State<ScanscanthaltiltCards> {
  ...
  final List<Map<String, dynamic>> _secondPageInstructions = [
    ...
    {
      'image': 'assets/Screenshot 2024-05-18 190404.png',
      'text': const Row(
        children: [
          Text(
            '❌ ',
...
// Use the cropped image without resizing
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => Canthaltiltmesh(
