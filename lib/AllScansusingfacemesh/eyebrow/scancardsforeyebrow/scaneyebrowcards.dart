...
import 'package:instaclone/AllScansusingfacemesh/eyebrow/eyebrowmesh/eyebrowmesh.dart';
...
class Scaneyebrowcards extends StatefulWidget {
  const Scaneyebrowcards({super.key});

  @override
  ScaneyebrowcardsState createState() => ScaneyebrowcardsState();
}

class ScaneyebrowcardsState extends State<Scaneyebrowcards> {
  ...
  final List<Map<String, dynamic>> _secondPageInstructions = [
    ...
    {
      'image': 'assets/Screenshot 2024-06-09 143133.png',
          'text': const Row(
  children: [
    Text( '❌ ',
...
// Use the cropped image without resizing
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => Eyebrowmesh(imageFile: File(croppedImage.path)), // Assuming FaceMeshScreen takes an imageFile argument
          ),
        );
      }
    }
