...
import 'package:instaclone/results/skintyperesults.dart';
...
class ScansskintypeCards extends StatefulWidget {
  const ScansskintypeCards({super.key});

  @override
  ScansskintypeCardsState createState() => ScansskintypeCardsState();
}

class ScansskintypeCardsState extends State<ScansskintypeCards> {
    ...
    try {
      ...
      if (_recognitions != null && _recognitions.isNotEmpty) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
               builder: (context) => Skintyperesults(results: v, image: _image!),
          ),
        );
      } else {
