...
import 'package:instaclone/results/ageresults.dart';
...
class ScansageCards extends StatefulWidget {
  const ScansageCards({super.key});

  @override
  ScansageCardsState createState() => ScansageCardsState();
}

class ScansageCardsState extends State<ScansageCards> {
  ...
  final List<Map<String, dynamic>> _secondPageInstructions = [
      ...
      'text': const Row(
        children: [
          Text(
            '✔',
            style: TextStyle(
                color: Color.fromARGB(255, 36, 255, 65), fontSize: 18),
          ),
          SizedBox(
    ...
    {
      'image':
          'assets/eraseid_3983329833LQQJwmSn2h06XHLBticihVXn14mysHT9vAQ6OYNHmjRRxsvHaxp0MmzOesrdP9ok_y7fFICAC (1) (1).jpg',
      'text': const Row(
        children: [
          Text(
            '❌ ',
    ...
    {
      'image':
          'assets/3662326623sD1M9nyuUU1ZYMqKQdfc9d6SgEZA0j7LBLgdyaHvPjQcuBIqZD7NF10Zk9hh3DSv_0_0_r.jpg',
      'text': const Row(
        children: [
          Text(
            '❌ ',
    ...
    try {
      ...
      if (pickedFile != null) {
        ...
        if (croppedImage != null) {
          ...
          File resizedImageFile = await File('${pickedFile.path}_resized.png')
          ...
          detectImage(
              resizedImageFile); // Send the resized image for processing
        }
      }
    } catch (e) {
    }
  ...
  loadModel() async {
    await Tflite.loadModel(
      model: "assets/modelforage.tflite",
      labels: "assets/labelsforage.txt",
    );
  }
      ...
      if (_recognitions != null && _recognitions.isNotEmpty) {
        ...
        if (_userCredits >= 10) {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => Ageresults(results: v, image: _image!),
            ),
          );
        } else {
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                ...
                                minimumSize: const Size(150,
                                    150), // Adjust the button size as needed
                              ),
                              child: const Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Icon(
                                        Icons
                                            .photo_camera, // Use the icon you prefer (e.g., Icons.photo_library)
                                        color: Colors
                                      ...
                                      Text(
                                        ...
                                        style: TextStyle(
                                          color: Colors.black,
                                          fontSize:
                                              17, // Adjust the text size as needed
                                        ),
                                      ),
                                    ],
                                  ),
                                  SizedBox(
                                      height:
                                          8), // Add some space between the text and the credits info
                                  Text(
                                    '(-10 credits)',
                                    style: TextStyle(
                                      color: Colors.black,
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Icon(
                                        Icons
                                            .photo_library, // Use the icon you prefer (e.g., Icons.photo_library)
                                        color: Colors
                                            .black, // Adjust the icon color as needed
                                      ),
                                      SizedBox(
